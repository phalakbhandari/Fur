...
_Note: Running tests for the first time requires the Playwright browser binaries: `npx playwright install chromium`._
...
MIT. See [LICENSE](LICENSE). Fonts are under the SIL Open Font License; all icon artwork is original to this project.
